...
const Projects = () => {
  return (
    <div className="md:pt-6 md:-mt-7">
      <h2 className="top-0 z-40 pt-6 my-10 text-sm font-bold tracking-widest uppercase text-white">
        Projects
      </h2>
      <div className="flex flex-wrap -my-4 md:-m-4 group pt-8 pb-9 md:py-0" >
        {[1, 2, 3, 4].map((index) => (
          <article
            className="flex-none w-full my-1 md:m-1 md:w-240 md:min-h-240 lg:w-320 lg:min-h-320 bg-dusk opacity-50 odd:-translate-y-12 art-card"
            key="index"
          >
